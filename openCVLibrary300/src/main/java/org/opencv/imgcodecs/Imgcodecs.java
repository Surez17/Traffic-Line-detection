...
public class Imgcodecs {
    ...
    public static boolean imwrite(String filename, String img)
    {
        
        boolean retVal = imwrite_1(filename, img);
    ...
    private static native boolean imwrite_1(String filename, String img_nativeObj);
